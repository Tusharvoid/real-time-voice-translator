...
def open_about_page():      # about page
    ...
    github_link = ttk.Label(about_window, text="Github profile", underline=True, foreground="blue", cursor="hand2")
    github_link.bind("<Button-1>", lambda e: open_webpage("https://github.com/Tusharvoid/real-time-voice-translator"))
    github_link.pack()
